...

{
    ...
    'version': '14.0.1.0.0',
    'category': 'Project',
    'summary': "Customization for odoo14_ce",
    ...
    'git-repos': [
        'https://github.com/regaby/cl-odoo14_ce.git',
        ## localizacion adhoc-quilsoft v 14.0
        'https://github.com/regaby/odoo-argentina-ce.git',
